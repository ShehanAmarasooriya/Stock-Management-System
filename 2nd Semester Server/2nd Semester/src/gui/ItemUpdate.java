...
public class ItemUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("          You Can Update Items Here");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(37, 37, 37)
                        .addComponent(qOnHandText, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(73, 73, 73))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(24, 24, 24)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(qOnHandText, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        updateButton.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 14)); // NOI18N
    ...
    private void updateButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMouseClicked
        try {
            ...
            int qtyOnHand = Integer.parseInt(qOnHandText.getText());
            Item item = new Item(code, description, unitPrice, qtyOnHand);
            ItemController itemController = ServerConnector.getServerConnector().getItemController();
            boolean res = itemController.updateItem(item);
            if (res) {
                JOptionPane.showMessageDialog(this, "Update Success");
            } else {
                JOptionPane.showMessageDialog(this, "Update Fail");
            }
            itemController.releaseItem(code);
        } catch (NotBoundException ex) {
            Logger.getLogger(ItemUpdate.class.getName()).log(Level.SEVERE, null, ex);
        } catch (MalformedURLException ex) {
            Logger.getLogger(ItemUpdate.class.getName()).log(Level.SEVERE, null, ex);
